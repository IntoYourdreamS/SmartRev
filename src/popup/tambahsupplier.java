...
public class tambahsupplier extends javax.swing.JFrame {
    ...
    public tambahsupplier() {
        ...
        alamat.setBackground(new Color(0, 0, 0, 0));
          ...
          makeButtonTransparent(tambah);
           ...
           makeButtonTransparent(kembali1); 
    ...
    private void initComponents() {
        ...
        getContentPane().add(tambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 380, 160, 40));
        ...
        getContentPane().add(ubah, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 380, 160, 40));
        ...
        getContentPane().add(kembali1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 20, 50, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Tambah Supplier10.png"))); // NOI18N
